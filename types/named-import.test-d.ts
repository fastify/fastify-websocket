...
import fastify, { ContextConfigDefault, FastifyBaseLogger, FastifyInstance, FastifyReply, FastifyRequest, FastifySchema, RawReplyDefaultExpression, RawRequestDefaultExpression, RawServerDefault, RequestGenericInterface, RouteOptions } from 'fastify';
import { RouteGenericInterface } from 'fastify/types/route';
import { ResolveFastifyRequestType } from 'fastify/types/type-provider';
import type { IncomingMessage } from "http";
import { expectType } from 'tsd';
import { Server } from 'ws';
import { SocketStream, WebsocketHandler, fastifyWebsocket as wsPlugin } from '.';
